...
namespace Sdcb.FFmpegAPIWrapper.MediaFormats
{
    public partial class MediaIO 
    {
        ...
        /// </summary>
        public static unsafe MediaIO Open(string url, IOFlags flags = IOFlags.Read, MediaDictionary? options = null)
        {
        ...
        public static unsafe MediaIO OpenRead(string url, MediaDictionary? options = null) => Open(url, IOFlags.Read, options);
        public static unsafe MediaIO OpenWrite(string url, MediaDictionary? options = null) => Open(url, IOFlags.Write, options);
